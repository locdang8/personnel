...
""",
    ...
    # always loaded
    'data': [
        'security/personel_security_data.xml',
        'security/ir.model.access.csv',
        'views/level_data.xml',
        'views/department_data.xml',
        'views/training_process_data.xml',
        'views/personnel_type_data.xml',
        # 'views/qtdt.xml',
        'views/actions.xml',
        'views/relative_data.xml',
        'views/templates.xml',
